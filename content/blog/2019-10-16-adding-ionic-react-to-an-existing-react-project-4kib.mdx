---
title: Adding Ionic React to an existing React project
publishedDate: 2019-10-16
summary: Earlier this week, we launched Ionic React (read the announcement here). To get started with a new Io...
canonicalUrl: https://dev.to/ionic/adding-ionic-react-to-an-existing-react-project-4kib
coverImage: ""
author: ely-lucas
---

Earlier this week, we launched Ionic React (read the announcement [here](https://ionicframework.com/blog/announcing-ionic-react/)). To get started with a new Ionic React project is quite easy, but what if you have an existing React project and want to integrate Ionic into it?
...
For more information on routing and navigation in Ionic React, see [here](https://ionicframework.com/docs/react/navigation).
...
For more info on theming your Ionic app, see the guide [here](https://ionicframework.com/docs/theming/themes).
